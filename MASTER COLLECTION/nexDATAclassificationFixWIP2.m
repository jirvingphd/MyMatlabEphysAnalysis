...
fprintf('Main script finished, running: renameDATAfileinfoDrinkTypeDay.\n')
renameDATAfileinfoDrinkTypeDay

fprintf('\nFINISHED.\nTO FIND OUTLIERS & COUNTS: findOutliers_DATA_RawSpikes_SaveBins_CutLicks.m \n\n');
fprintf('OR FOR JUST COUNTS: nexDATAcountUnitsFinal.m \n');
